...
\hypersetup{
  ...
  urlcolor=blue,
  citecolor=black,
  pdftitle={Cover letter: DT-GSK revised submission (algorithms-4507562)},
  pdfauthor={Mostafa Elsayed Ahmed Masoud, Heba Sayed Mohamed Roshdy, Ali Wagdy Mohamed},
  pdfsubject={Cover letter for the revised manuscript DT-GSK, Algorithms (MDPI)},
}
...
\begin{flushright}
\textsc{Mostafa Elsayed Ahmed Masoud}\\
...
\textbf{Manuscript:} \textit{DT-GSK: Dimension-Tiered Adaptive Configuration Selection and Deterministic Refinement for Gaining-Sharing Knowledge-Based Optimization Algorithm}, algorithms-4507562, revision 1\\
\textbf{Authors:} Mostafa Elsayed Ahmed Masoud, Heba Sayed Mohamed Roshdy, Ali Wagdy Mohamed\\
\textbf{Corresponding author:} Mostafa Elsayed Ahmed Masoud \;(\href{mailto:moustafa.masoud@gmail.com}{moustafa.masoud@gmail.com})
