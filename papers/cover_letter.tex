...
We believe the manuscript fits \textit{Algorithms} well: an algorithmic contribution with a fully specified mechanism, a reproducible artifact chain in a public, tagged repository, and empirical claims scoped throughout to the seven-algorithm GSK family --- we make no field-wide performance claims.
