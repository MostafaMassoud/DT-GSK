...
> published to the public repository** (v2.14 → v2.43, including the round-two
...
>
> **Freeze:** pass-70, tag **v2.43** (v2.13 … v2.43 all resolve; the DAS names v2.13/v2.37), decision log through **D-0075**,
