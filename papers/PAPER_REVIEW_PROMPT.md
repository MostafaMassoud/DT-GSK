...
> published to the public repository** (v2.14 → v2.45, including the round-two
...
>
> **Freeze:** pass-72, tag **v2.45** (v2.13 … v2.45 all resolve; the DAS names v2.13/v2.37), decision log through **D-0077**,
