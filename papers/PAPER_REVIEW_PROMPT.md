...
> ## DEFINITIVE CURRENT STATE — 2026-08-29 (pass-63 / v2.36; round-two, reopened-items, acceptance-readiness, panel-review, full-remediation, deferred-items-closure, re-review, queue-closure and author-metadata batches APPLIED; resubmission due 2026-09-01) — read this first; it supersedes every layer below on any conflict
>
...
> published to the public repository** (v2.14 → v2.36, including the round-two
...
>
> **Freeze:** pass-63, tag **v2.36** (v2.13 … v2.36 all resolve), decision log through **D-0068**,
