...
> published to the public repository** (v2.14 → v2.41, including the round-two
...
>
> **Freeze:** pass-68, tag **v2.41** (v2.13 … v2.41 all resolve; the DAS names v2.13/v2.37), decision log through **D-0073**,
