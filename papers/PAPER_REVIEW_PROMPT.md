...
> published to the public repository** (v2.14 → v2.46, including the round-two
...
>
> **Freeze:** pass-73, tag **v2.46** (v2.13 … v2.46 all resolve; the DAS names v2.13/v2.37), decision log through **D-0078**,
