...
> published to the public repository** (v2.14 → v2.42, including the round-two
...
>
> **Freeze:** pass-69, tag **v2.42** (v2.13 … v2.42 all resolve; the DAS names v2.13/v2.37), decision log through **D-0074**,
