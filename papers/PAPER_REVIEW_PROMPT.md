...
> ## DEFINITIVE CURRENT STATE — 2026-08-28 night (pass-51 / v2.24; round-two, reopened-items and acceptance-readiness batches APPLIED; resubmission due 2026-09-01) — read this first; it supersedes every layer below on any conflict
>
...
> published to the public repository** (v2.14 → v2.24, including the round-two
...
>
> **Freeze:** pass-51, tag **v2.24** (v2.13 … v2.24 all resolve), decision log through **D-0056**,
> change requests through **CR-0031**; next free ids **CR-0032 / D-0057** (verify free at apply
...
> that pass-42 slipped through. Any manuscript edit voids pass-51 → pass-52 re-mint + tag v2.25
...
FREEZE_STATE:            Pass-49 (tag v2.22; v2.13..v2.22 all resolve; decision log
                         ...
                         ids CR-0032 / D-0057 -- verify free at apply time),
