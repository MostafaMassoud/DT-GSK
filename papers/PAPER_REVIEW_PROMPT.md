...
> ## DEFINITIVE CURRENT STATE — 2026-08-29 (pass-58 / v2.31; round-two, reopened-items, acceptance-readiness, panel-review, full-remediation, deferred-items-closure, re-review, queue-closure and author-metadata batches APPLIED; resubmission due 2026-09-01) — read this first; it supersedes every layer below on any conflict
>
...
> published to the public repository** (v2.14 → v2.31, including the round-two
...
>
> **Freeze:** pass-58, tag **v2.31** (v2.13 … v2.31 all resolve), decision log through **D-0063**,
> change requests through **CR-0038**; next free ids **CR-0039 / D-0064** (verify free at apply
