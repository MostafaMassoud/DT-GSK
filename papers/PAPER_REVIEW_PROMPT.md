...
> ## DEFINITIVE CURRENT STATE — 2026-08-29 (pass-56 / v2.29; round-two, reopened-items, acceptance-readiness, panel-review, full-remediation, deferred-items-closure and re-review batches APPLIED; resubmission due 2026-09-01) — read this first; it supersedes every layer below on any conflict
>
...
> published to the public repository** (v2.14 → v2.29, including the round-two
...
>
> **Freeze:** pass-56, tag **v2.29** (v2.13 … v2.29 all resolve), decision log through **D-0061**,
> change requests through **CR-0036**; next free ids **CR-0037 / D-0062** (verify free at apply
