...
> published to the public repository** (v2.14 → v2.40, including the round-two
...
>
> **Freeze:** pass-67, tag **v2.40** (v2.13 … v2.40 all resolve; the DAS names v2.13/v2.37), decision log through **D-0072**,
