...
> ## DEFINITIVE CURRENT STATE — 2026-08-29 (pass-57 / v2.30; round-two, reopened-items, acceptance-readiness, panel-review, full-remediation, deferred-items-closure, re-review and queue-closure batches APPLIED; resubmission due 2026-09-01) — read this first; it supersedes every layer below on any conflict
>
...
> published to the public repository** (v2.14 → v2.30, including the round-two
...
>
> **Freeze:** pass-57, tag **v2.30** (v2.13 … v2.30 all resolve), decision log through **D-0062**,
> change requests through **CR-0037**; next free ids **CR-0038 / D-0063** (verify free at apply
