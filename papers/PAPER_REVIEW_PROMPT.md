...
> ## DEFINITIVE CURRENT STATE — 2026-08-29 (pass-60 / v2.33; round-two, reopened-items, acceptance-readiness, panel-review, full-remediation, deferred-items-closure, re-review, queue-closure and author-metadata batches APPLIED; resubmission due 2026-09-01) — read this first; it supersedes every layer below on any conflict
>
...
> published to the public repository** (v2.14 → v2.33, including the round-two
...
>
> **Freeze:** pass-60, tag **v2.33** (v2.13 … v2.33 all resolve), decision log through **D-0065**,
> change requests through **CR-0040**; next free ids **CR-0041 / D-0066** (verify free at apply
