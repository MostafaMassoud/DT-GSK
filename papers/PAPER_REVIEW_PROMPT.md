...
> ## DEFINITIVE CURRENT STATE — 2026-08-29 (pass-59 / v2.32; round-two, reopened-items, acceptance-readiness, panel-review, full-remediation, deferred-items-closure, re-review, queue-closure and author-metadata batches APPLIED; resubmission due 2026-09-01) — read this first; it supersedes every layer below on any conflict
>
...
> published to the public repository** (v2.14 → v2.32, including the round-two
...
>
> **Freeze:** pass-59, tag **v2.32** (v2.13 … v2.32 all resolve), decision log through **D-0064**,
> change requests through **CR-0039**; next free ids **CR-0040 / D-0065** (verify free at apply
