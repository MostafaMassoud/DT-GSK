...
$=$ no significant difference, $-$ worse).}\label{tab:wilcoxon-holm}
\centering
\tablesize{\footnotesize}
...
\caption{Critical-difference view of the CEC2017 GSK-family Friedman mean
...
% BIND: ART-PARAMS (_dt_profiles.py tier dicts, hash-frozen); tab:architecture categories; tab:dim-gating activation rows; additive taxonomy clarification --- registered RS-12 wording untouched
...
\caption{Family-overlay convergence on CEC2017 at $D = 30$ ---
...
\caption{Family-overlay convergence on CEC2017 at $D = 100$, the tier where
...
% BIND: E2 (rev-rel-2026-08-26-dd42d37eb); rank-claim qualification
Third, CEC2017 is
