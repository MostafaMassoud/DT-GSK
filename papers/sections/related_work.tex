...
%------------------------------------------------------------------
\subsection{The GSK Family: From Fixed Parameters to Adaptive Control}\label{sec:rel:family}
%------------------------------------------------------------------
...
re-extracted every fifth generation). Authored from literature facts drawn from the cited sources
only.}
\label{tab:taxonomy}
\centering
\scriptsize
