...
% Canonical pseudocode (ART-PSEUDOCODE, label alg:dt-gsk). Rendering restyled
% 2026-08-29 (pass-60) for single-line steps: sections/algorithm_pseudocode_render.tex.
% Semantics and the frozen loop order are unchanged; the canonical source of
% record remains phase_03/algorithm_pseudocode.md, and the phase_03 LaTeX
% rendering stays frozen in its append-only tree.
\input{sections/algorithm_pseudocode_render.tex}
