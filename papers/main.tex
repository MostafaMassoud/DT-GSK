...
ChatGPT (5.5; OpenAI). They assisted with language editing and rephrasing; the
...
% amendment) and its version 5.5 author-supplied the same day. The ChatGPT
% version is an AUTHOR ATTESTATION: it was not verified against a product
% catalogue, and this project does not name anything on inference. D-0032 had
% withheld a version for exactly that reason; the author supplying it directly
% is what resolves it, since the disclosure is the authors' own statement.
\acknowledgments{During the preparation and revision of this manuscript, the
authors used Claude (Opus 4.6, 4.8 and 5.0; Anthropic) and ChatGPT (5.5; OpenAI) for
