...
\noindent Four of the five experiments in this section were requested by the
round-one reviewers to isolate mechanisms that the submitted manuscript had
introduced together; the fifth (Section~@@REF!sec:supp:rev:boundary@@) answers
the boundary half of the same sensitivity request and was added ahead of
resubmission.  Their designs, estimands, statistical conventions and the wording to
...
single release carries it: the arms added in round one come from the separate,
non-superseding release rev-rel-2026-08-26-dd42d37eb; the boundary arms of
...
Added ahead of resubmission and registered before execution (pre-registration
Amendment A4): the study of Section~@@REF!sec:supp:rev:sensitivity@@ varies
constants within tiers, and the reviewer request it answers also names the
tier boundaries themselves.  Each cell here shifts one boundary of the frozen
