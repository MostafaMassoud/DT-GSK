...
\item \textbf{Target selection (two branches).} With $S=\sum_m d_m$: if $S>0$
  ...
  \hfill\_ace\_apply\_credit, \_dt\_core.py
...
\item \textbf{ARGP freeze.} After a warm-up fraction of the budget, an unfrozen
  ...
  single arm. \hfill ARGP retirement branch, \_dt\_core.py
...
single release carries it: the arms added in revision come from the separate,
non-superseding release rev-rel-2026-08-26-dd42d37eb; the comparator columns
