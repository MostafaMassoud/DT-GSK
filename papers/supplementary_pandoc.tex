...
\title{Supplementary Material for: DT-GSK: Dimension-Tiered Adaptive Configuration Selection and Deterministic Refinement for Gaining-Sharing Knowledge Optimization}
\author{Mostafa Elsayed Ahmed Masoud @@SUP!1,*@@, Heba Sayed Mohamed Roshdy @@SUP!1@@ and Ali Wagdy Mohamed @@SUP!1,2@@}
\date{}
...
moustafa.masoud@gmail.com (M.E.A.M.\ ORCID 0009-0003-8415-2158); hmhmdss@yahoo.com (H.S.M.R.\ ORCID 0000-0003-0387-5876); aliwagdy@gmail.com (A.W.M.\ ORCID 0000-0002-5895-2632)\\
@@SUP!2@@ \quad University of Science and Technology, Zewail City of Science and
Technology, 6th of October City, Giza 12588, Egypt\\
...
\section{@@SECNUM!sec:supp:cec2017-tables!S1.@@ Complete CEC2017 Per-Function Panel Tables}\label{sec:supp:cec2017-tables}
...
@@TABLECAP!tab:cec2017-functions!SA04@@ CEC2017 scored-function inventory: class and known optimal value
...
@@TABLECAP!tab:cec2017-d10!T7@@ CEC2017 at $D = 10$: mean $\pm$ SD of the final error over 51
...
@@TABLECAP!tab:cec2017-d30!T8@@ CEC2017 at $D = 30$: mean $\pm$ SD of the final error over 51
runs for all 7 GSK-family algorithms on each of the 29 functions (F1,
F3--F30; success floor $10^{-8}$); best mean per function in bold.
  \apgsk{} cells
derive from the final-checkpoint columns of the per-generation logs
...
@@TABLECAP!tab:cec2017-d50!T9@@ CEC2017 at $D = 50$: mean $\pm$ SD of the final error over 51
runs for all 7 GSK-family algorithms on each of the 29 functions (F1,
F3--F30; success floor $10^{-8}$); best mean per function in bold.
  \apgsk{} cells
derive from the final-checkpoint columns of the per-generation logs
...
@@TABLECAP!tab:cec2017-d100!T10@@ CEC2017 at $D = 100$: mean $\pm$ SD of the final error over 51
runs for all 7 GSK-family algorithms on each of the 29 functions (F1,
F3--F30; success floor $10^{-8}$); best mean per function in bold.
...
\section{@@SECNUM!sec:supp:pairwise!S2.@@ Pairwise Matrices and Additional-Suite Detail}\label{sec:supp:pairwise}


\subsection{@@SECNUM!sec:supp:h2h!S2.1.@@ CEC2017 Head-to-Head Detail: \dtgsk{} vs.\ GSK}\label{sec:supp:h2h}

Tables~@@REF!tab:h2h\_d10@@--@@REF!tab:h2h\_d100@@ report the five-statistic
...
@@TABLECAP!tab:h2h\_d10!T2@@ CEC2017 at $D = 10$ (29 functions, 51 runs): best / median /
worst / mean / SD of the final error (success floor $10^{-8}$) for GSK
vs.\ \dtgsk{}; best mean per function in bold.  Two-algorithm detail
behind the family-panel exhibits --- no panel-wide claim.
...
@@TABLECAP!tab:h2h\_d30!T3@@ CEC2017 at $D = 30$ (29 functions, 51 runs): best / median /
worst / mean / SD of the final error (success floor $10^{-8}$) for GSK
vs.\ \dtgsk{}; best mean per function in bold.  Two-algorithm detail
behind the family-panel exhibits --- no panel-wide claim.
...
@@TABLECAP!tab:h2h\_d50!T4@@ CEC2017 at $D = 50$ (29 functions, 51 runs): best / median /
worst / mean / SD of the final error (success floor $10^{-8}$) for GSK
vs.\ \dtgsk{}; best mean per function in bold.  Two-algorithm detail
behind the family-panel exhibits --- no panel-wide claim.
...
@@TABLECAP!tab:h2h\_d100!T5@@ CEC2017 at $D = 100$ (29 functions, 51 runs): best / median /
worst / mean / SD of the final error (success floor $10^{-8}$) for GSK
vs.\ \dtgsk{}; best mean per function in bold.  Two-algorithm detail
behind the family-panel exhibits --- no panel-wide claim.
...
\clearpage
\subsection{@@SECNUM!sec:supp:cec2011!S2.2.@@ CEC2011 Detail}\label{sec:supp:cec2011}
...
@@TABLECAP!tab:cec2011-stats!T6@@ Across-problem Wilcoxon signed-rank summary, \dtgsk{} vs.\ GSK
...
(Holm-corrected $p = 4.2 \times 10^{-2}$).
...
@@TABLECAP!tab:cec2011-perproblem!T1@@ CEC2011 real-world suite (22 problems, native dimensions, 25 runs,
...
a panel-wide best claim.

@@NATIVETABLE!T1@@



\subsection{@@SECNUM!sec:supp:cec2013!S2.3.@@ CEC2013 Second Comparison Suite Detail}\label{sec:supp:cec2013}
...
$30$, and $50$; Table~@@REF!tab:cec2013\_wilcoxon@@ gives the
across-function Wilcoxon signed-rank summary per dimension, and
Table~@@REF!tab:cec2013-pairwise@@ the complete Wilcoxon--Holm matrix
against all six comparators.
...
@@TABLECAP!tab:cec2013-d10!T11@@ CEC2013 second comparison suite at $D = 10$ (28 functions,
51 runs): best / median / worst / mean / SD of the final error for GSK
vs.\ \dtgsk{}; best mean per function in bold.  CEC2013 is a second
comparison suite reported for breadth of comparison.
...
@@TABLECAP!tab:cec2013-d30!T12@@ CEC2013 second comparison suite at $D = 30$ (28 functions,
51 runs): best / median / worst / mean / SD of the final error for GSK
...
behind \egsk{} ($3.07$) and \atmals{} ($3.34$).
...
@@TABLECAP!tab:cec2013-d50!T13@@ CEC2013 second comparison suite at $D = 50$ (28 functions,
51 runs): best / median / worst / mean / SD of the final error for GSK
vs.\ \dtgsk{}; best mean per function in bold.
...
@@TABLECAP!tab:cec2013\_wilcoxon!T14@@ Across-function Wilcoxon signed-rank summary, \dtgsk{} vs.\ GSK
...
@@TABLECAP!tab:cec2013-pairwise!SA03@@ Complete across-function Wilcoxon--Holm matrix on the CEC2013 second
...
(Table~@@REF!tab:cec2013\_wilcoxon@@).  Of the eighteen contrasts, five are
...
\subsection{@@SECNUM!sec:supp:bca!S2.4.@@ Descriptive Bootstrap Rank-Stability Intervals on the CEC2017 Friedman Mean Ranks}\label{sec:supp:bca}
...
@@TABLECAP!tab:bca-ci!T16\_bca@@ $95\%$ bootstrap BCa descriptive rank-stability intervals on the CEC2017
...
@@NATIVETABLE!T16\_bca@@



\subsection{@@SECNUM!sec:supp:posthoc!S2.5.@@ Post-hoc Robustness: Endpoint Choice and Randomization Inference}\label{sec:supp:posthoc}
...
\subsection{@@SECNUM!sec:supp:rankviews!S2.6.@@ Additional CEC2017 Rank Views: Overall Bars and Dimension Trend}\label{sec:supp:rankviews}
...
\begin{figure}[htbp]
\includegraphics[width=0.72\textwidth]{figures/ranks/friedman_gsk_family.png}
\caption{@@FIGCAP!fig:supp-overall-ranks@@ Overall (dimension-aggregated) Friedman mean rank of the seven GSK-family
...
\begin{figure}[htbp]
\includegraphics[width=0.82\textwidth]{figures/ranks/rank_vs_dim_cec2017.png}
\caption{@@FIGCAP!fig:supp-rank-trend@@ CEC2017 Friedman mean rank against problem dimension
...
\section{@@SECNUM!sec:supp:convergence!S3.@@ Convergence Figure Sets}\label{sec:supp:convergence}
...
\subsection{@@SECNUM!sec:supp:conv2017!S3.1.@@ CEC2017: All 29 Functions at Each Dimension}\label{sec:supp:conv2017}
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D10_a.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d10-a@@ Family-overlay convergence on CEC2017 at $D = 10$, functions
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D10_b.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d10-b@@ Family-overlay convergence on CEC2017 at $D = 10$, functions
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D10_c.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d10-c@@ Family-overlay convergence on CEC2017 at $D = 10$, functions
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D10_d.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d10-d@@ Family-overlay convergence on CEC2017 at $D = 10$, functions
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D30_a.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d30-a@@ Family-overlay convergence on CEC2017 at $D = 30$, functions
F1, F3--F9 (sub-grid a of 4): per-checkpoint mean error across 51 runs
per algorithm (identical basis for all 7 curves; no smoothing), fixed
Okabe--Ito style map, \dtgsk{} solid black, one shared legend,
log-error $y$-axis with display-only floor $10^{-14}$ for exact zeros.
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D30_b.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d30-b@@ Family-overlay convergence on CEC2017 at $D = 30$, functions
F10--F17 (sub-grid b of 4): per-checkpoint mean error across 51 runs per
algorithm, 7-curve overlay, log-error $y$-axis (display floor
$10^{-14}$), one shared legend.  \apgsk{} checkpoint evidence at this
dimension derives from per-generation logs (disclosed limitation).
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D30_c.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d30-c@@ Family-overlay convergence on CEC2017 at $D = 30$, functions
F18--F25 (sub-grid c of 4): per-checkpoint mean error across 51 runs per
algorithm, 7-curve overlay, log-error $y$-axis (display floor
$10^{-14}$), one shared legend.  \apgsk{} checkpoint evidence at this
dimension derives from per-generation logs (disclosed limitation).
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D30_d.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d30-d@@ Family-overlay convergence on CEC2017 at $D = 30$, functions
F26--F30 (sub-grid d of 4): per-checkpoint mean error across 51 runs per
algorithm, 7-curve overlay, log-error $y$-axis (display floor
$10^{-14}$), one shared legend.  \apgsk{} checkpoint evidence at this
dimension derives from per-generation logs (disclosed limitation).
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D50_a.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d50-a@@ Family-overlay convergence on CEC2017 at $D = 50$, functions
F1, F3--F9 (sub-grid a of 4): per-checkpoint mean error across 51 runs
per algorithm (identical basis for all 7 curves; no smoothing), fixed
Okabe--Ito style map, \dtgsk{} solid black, one shared legend,
log-error $y$-axis with display-only floor $10^{-14}$ for exact zeros.
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D50_b.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d50-b@@ Family-overlay convergence on CEC2017 at $D = 50$, functions
F10--F17 (sub-grid b of 4): per-checkpoint mean error across 51 runs per
algorithm, 7-curve overlay, log-error $y$-axis (display floor
$10^{-14}$), one shared legend.  \apgsk{} checkpoint evidence at this
dimension derives from per-generation logs (disclosed limitation).
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D50_c.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d50-c@@ Family-overlay convergence on CEC2017 at $D = 50$, functions
F18--F25 (sub-grid c of 4): per-checkpoint mean error across 51 runs per
algorithm, 7-curve overlay, log-error $y$-axis (display floor
$10^{-14}$), one shared legend.  \apgsk{} checkpoint evidence at this
dimension derives from per-generation logs (disclosed limitation).
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D50_d.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d50-d@@ Family-overlay convergence on CEC2017 at $D = 50$, functions
F26--F30 (sub-grid d of 4): per-checkpoint mean error across 51 runs per
algorithm, 7-curve overlay, log-error $y$-axis (display floor
$10^{-14}$), one shared legend.  \apgsk{} checkpoint evidence at this
dimension derives from per-generation logs (disclosed limitation).
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D100_a.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d100-a@@ Family-overlay convergence on CEC2017 at $D = 100$, functions
F1, F3--F9 (sub-grid a of 4): per-checkpoint mean error across 51 runs
per algorithm (identical basis for all 7 curves; no smoothing), fixed
Okabe--Ito style map, \dtgsk{} solid black, one shared legend,
log-error $y$-axis with display-only floor $10^{-14}$ for exact zeros.
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D100_b.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d100-b@@ Family-overlay convergence on CEC2017 at $D = 100$, functions
F10--F17 (sub-grid b of 4): per-checkpoint mean error across 51 runs per
algorithm, 7-curve overlay, log-error $y$-axis (display floor
$10^{-14}$), one shared legend.  \apgsk{} checkpoint evidence at this
dimension derives from per-generation logs (disclosed limitation).
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D100_c.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d100-c@@ Family-overlay convergence on CEC2017 at $D = 100$, functions
F18--F25 (sub-grid c of 4): per-checkpoint mean error across 51 runs per
algorithm, 7-curve overlay, log-error $y$-axis (display floor
$10^{-14}$), one shared legend.  \apgsk{} checkpoint evidence at this
dimension derives from per-generation logs (disclosed limitation).
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/all_funcs_D100_d.png}
\caption{@@FIGCAP!fig:sconv-cec2017-d100-d@@ Family-overlay convergence on CEC2017 at $D = 100$, functions
F26--F30 (sub-grid d of 4): per-checkpoint mean error across 51 runs per
...
\subsection{@@SECNUM!sec:supp:conv2011!S3.2.@@ CEC2011: All 22 Real-World Problems}\label{sec:supp:conv2011}
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/cec2011_a.png}
\caption{@@FIGCAP!fig:sconv-cec2011-a@@ Family-overlay convergence on the CEC2011 real-world optimization benchmark suite,
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/cec2011_b.png}
\caption{@@FIGCAP!fig:sconv-cec2011-b@@ Family-overlay convergence on the CEC2011 real-world optimization benchmark suite,
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/cec2011_c.png}
\caption{@@FIGCAP!fig:sconv-cec2011-c@@ Family-overlay convergence on the CEC2011 real-world optimization benchmark suite,
...
\subsection{@@SECNUM!sec:supp:conv2013!S3.3.@@ CEC2013 Second Comparison Suite: All 28 Functions at $D = 30$}\label{sec:supp:conv2013}
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/cec2013_a.png}
\caption{@@FIGCAP!fig:sconv-cec2013-d30-a@@ Family-overlay convergence on the CEC2013 second comparison
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/cec2013_b.png}
\caption{@@FIGCAP!fig:sconv-cec2013-d30-b@@ Family-overlay convergence on the CEC2013 second comparison
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/cec2013_c.png}
\caption{@@FIGCAP!fig:sconv-cec2013-d30-c@@ Family-overlay convergence on the CEC2013 second comparison
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/convergence/cec2013_d.png}
\caption{@@FIGCAP!fig:sconv-cec2013-d30-d@@ Family-overlay convergence on the CEC2013 second comparison
...
\section{@@SECNUM!sec:supp:diagnostics!S4.@@ Population-Schedule Visualization and Diagnostic Availability}\label{sec:supp:diagnostics}
...
\begin{figure}[H]
\includegraphics[width=0.85\textwidth]{figures/concept/fig_nlpsr_schedule.png}
\caption{@@FIGCAP!fig:nlpsr-schedule@@ Analytic trajectory of the tier-floored nonlinear population
...
\section{@@SECNUM!sec:repro!S5.@@ Reproducibility Appendix}\label{sec:repro}
...
\subsection{@@SECNUM!sec:repro:seeds!S5.1.@@ Seed Schedule and Pairing}\label{sec:repro:seeds}
...
\begin{table}[H]
\caption{@@TABLECAP!tab:notation-rng@@ RNG substream key. The 13 append-only, prefix-locked substreams of
...
\subsection{@@SECNUM!sec:repro:freeze!S5.2.@@ Frozen Configuration and Freeze Manifest}\label{sec:repro:freeze}
...
\begin{table}[H]
\caption{@@TABLECAP!tab:comparator-params@@ GSK-family comparator parameter settings as run in this study. Values
...
\subsection{@@SECNUM!sec:repro:tuning!S5.3.@@ Configuration Selection and Development Protocol}\label{sec:repro:tuning}
...
\subsection{@@SECNUM!sec:repro:limitations!S5.4.@@ Limitations in Full}\label{sec:repro:limitations}
...
follows the conclusions stated there, so that nothing is
softened in transit.
...
should be read, in both directions. 
...
port and initialization asymmetries disclosed below. 
...
(Supplementary Material, Section~S6.7). 
...
method such as differential grouping --- enters any panel, table, figure or
claim here to calibrate the family against the broader state of the art; the
repository does contain runnable non-GSK implementations and, for three
large-scale specialists, CEC2013LSGO result banks produced under this paper's
protocol, none of them analysed here (Section~S7.1).  The standings are
...
--- a disclosed fairness asymmetry.  It is bounded by the
matched-initial-population control of Section~S9.2: held to the comparators'
initial $NP = 100$, \dtgsk{} stays within the panel's top two at every
CEC2017 dimension, but its first places at $D = 50$ and $D = 100$ do not
survive, so those two rank claims rest in part on the population rule.  The
asymmetry is most consequential at low dimension, where \dtgsk{} runs
essentially the scaffold.
...
frozen panel's 51.  The tier boundaries themselves are varied separately in
Section~@@REF!sec:supp:rev:boundary@@, where the shipped middle profile is beaten
from both neighbouring tiers at $D = 30$ and the $50 \leq D < 100$ set beats the
shipped upper profile at $D = 100$, while the $D = 10$ and $D = 50$ boundaries are
insensitive to the tested shifts.  Neither ARGP nor the deep-stall
...
\subsection{@@SECNUM!sec:repro:tieband!S5.5.@@ Sensitivity of the Win/Tie/Loss Tally to the Tie Band}\label{sec:repro:tieband}
...
\subsection{@@SECNUM!sec:repro:aliases!S5.6.@@ Legacy Identifiers}\label{sec:repro:aliases}
...
\begin{table}[H]
\caption{@@TABLECAP!tab:aliases@@ Current names and the legacy identifiers retained in released
artifacts.}
\label{tab:aliases}
\small
...
\subsection{@@SECNUM!sec:repro:acronyms!S5.7.@@ Acronyms}\label{sec:repro:acronyms}

The main-text notation table defines every mathematical symbol.
Table~@@REF!tab:acronyms@@ covers the acronyms that appear in prose but carry no
symbol, so a reader meeting one out of order does not have to search for its
first use.


\begin{table}[H]
\caption{@@TABLECAP!tab:acronyms@@ Acronyms used in the text that are not mathematical symbols.}
\label{tab:acronyms}
\small
\begin{tabular}{ll}
\toprule
...
\subsection{@@SECNUM!sec:repro:params-detail!S5.8.@@ Frozen Parameters: Per-Subsystem Detail}\label{sec:repro:params-detail}
...
\begin{table}[H]
\caption{@@TABLECAP!tab:parameters-detail@@ Frozen run parameters of the shipped configuration (per-subsystem
...
four tiers $D{<}20$ / $20$--$49$ / $50$--$99$ / ${\ge}100$ are shown. No
per-suite or per-run tuning is performed: every value is resolved from $D$
alone. Hash-frozen in algorithm\_freeze\_manifest.json.}
...
\subsection{@@SECNUM!sec:repro:opspec!S5.9.@@ Complete Operator Specification}\label{sec:repro:opspec}
...
\paragraph{Deterministic final polish (main-text Equation~(12)) and residual constants.}
...
\subsection{@@SECNUM!sec:repro:release!S5.10.@@ Evidence Release, Checksums, and Promotion Pipeline}\label{sec:repro:release}
...
evidence release accompanying this article (release
rel-2026-07-20-67d9345f9, anchor commit
67d9345f9502a9a584e645fa8948f60a61d70e29) --- except those of
Section~@@REF!sec:supp:revision@@, which carry the compound provenance that
section states.  That primary release's manifest
...
\section{@@SECNUM!sec:supp:ablation!S6.@@ Component-Contribution Study: Scaffold Remove-One Ablation}\label{sec:supp:ablation}
...
\subsection{@@SECNUM!sec:supp:ablation:design!S6.1.@@ Remove-One Design}\label{sec:supp:ablation:design}
...
\subsection{@@SECNUM!sec:supp:ablation:stats!S6.2.@@ Statistical Treatment}\label{sec:supp:ablation:stats}
...
@@TABLECAP!tab:abl-scaffold!SA01@@ Scaffold remove-one ablation on CEC2017: mean Friedman rank of each
...
($\alpha = 0.05$; Table~@@REF!tab:abl-wilcoxon@@).
...
\begin{figure}[H]
\includegraphics[width=0.92\textwidth]{figures/ablation/abl_rank_delta.png}
\caption{@@FIGCAP!fig:abl-rankdelta@@ Conditional rank degradation from removing each scaffold component on
...
@@TABLECAP!tab:abl-wilcoxon!SA02@@ Scaffold remove-one ablation on CEC2017: full-vs-cell paired Wilcoxon
...
\emph{favorable} (removing the component degrades performance).

@@NATIVETABLE!SA02@@



\subsection{@@SECNUM!sec:supp:ablation:findings!S6.3.@@ Findings (Conditional, ISM Off)}\label{sec:supp:ablation:findings}
...
\subsection{@@SECNUM!sec:supp:ablation:limits!S6.4.@@ What This Study Does Not Establish}\label{sec:supp:ablation:limits}
...
\subsection{@@SECNUM!sec:supp:ablation:sgsm!S6.5.@@ ISM-Overlay Isolation: Direct Component Study}\label{sec:supp:ablation:sgsm}
...
\begin{table}[H]
\caption{@@TABLECAP!tab:ism-isolation@@ Direct ISM-overlay isolation: the full overlay versus each
...
\subsection{@@SECNUM!sec:supp:ablation:subset!S6.6.@@ Conditional-Benefit Analysis by Function Class (Post-Hoc)}\label{sec:supp:ablation:subset}
...
\begin{table}[H]
\caption{@@TABLECAP!tab:ism-subset@@ Post-hoc conditional-benefit analysis: per-function win/tie/loss of the full
...
No class shows a benefit that survives even a nominal sign test
(Table~@@REF!tab:ism-subset@@; all subset
...
\subsection{@@SECNUM!sec:supp:ablation:caveats!S6.7.@@ Implementation Caveats: Two Corrected Defects and Their Evidence Trail}\label{sec:supp:ablation:caveats}
...
\section{@@SECNUM!sec:supp:cec2013lsgo!S7.@@ CEC2013LSGO Large-Scale Suite}\label{sec:supp:cec2013lsgo}

\subsection{@@SECNUM!sec:supp:lsgo:protocol!S7.1.@@ Protocol, Evidential Tiers, and Scope}\label{sec:supp:lsgo:protocol}
...
Statement additionally holds exploratory ports of SHADE-ILS, MOS
and DECC-G --- the first two vendored byte-faithful copies, DECC-G first-party
code written from its source paper, as that statement records --- executed on
this suite under the same harness and seed schedule.
...
\subsection{@@SECNUM!sec:supp:lsgo:config!S7.2.@@ Configuration Provenance on This Suite}\label{sec:supp:lsgo:config}
...
\subsection{@@SECNUM!sec:supp:lsgo:ranks!S7.3.@@ Family Friedman and Nemenyi View (Descriptive After Inspection)}\label{sec:supp:lsgo:ranks}
...
\begin{table}[H]
\caption{@@TABLECAP!tab:supp:lsgo:ranks@@ CEC2013LSGO family-only tie-corrected Friedman mean ranks over
...
\subsection{@@SECNUM!sec:supp:lsgo:pairwise!S7.4.@@ Across-Function Wilcoxon (Supporting, With Disclosure)}\label{sec:supp:lsgo:pairwise}
...
\begin{table}[H]
\caption{@@TABLECAP!tab:supp:lsgo:wilcoxon@@ Across-function Wilcoxon signed-rank layer on CEC2013LSGO,
...
\subsection{@@SECNUM!sec:supp:lsgo:runlevel!S7.5.@@ Run-Level Paired Wilcoxon (Registered Confirmatory Layer)}\label{sec:supp:lsgo:runlevel}
...
\begin{table}[p]
\caption{@@TABLECAP!tab:supp:lsgo:runlevel@@ Registered confirmatory layer on CEC2013LSGO: per-function
...
\subsection{@@SECNUM!sec:supp:lsgo:effects!S7.6.@@ Effect Sizes}\label{sec:supp:lsgo:effects}
...
\begin{table}[p]
\caption{@@TABLECAP!tab:supp:lsgo:effects@@ Run-level effect sizes on CEC2013LSGO: $A_{12}$/Cliff's
...
\subsection{@@SECNUM!sec:supp:lsgo:detail!S7.7.@@ Per-Function Detail}\label{sec:supp:lsgo:detail}
...
\begin{table}[p]
\caption{@@TABLECAP!tab:supp:lsgo-detail-a@@ CEC2013LSGO per-function detail (F1--F8): best / median / mean /
...
\begin{table}[p]
\caption{@@TABLECAP!tab:supp:lsgo-detail-b@@ CEC2013LSGO per-function detail (F9--F15): best / median / mean /
worst / SD of the raw best objective over 25 runs for all 7 GSK-family
algorithms at the native dimension ($D = 1000$; F13/F14 at $D = 905$);
best mean per function in bold (ties all bold).  F3, F6 and F10 ran the
transformed Ackley variant and are not comparable to published
...
\section{@@SECNUM!sec:supp:cec2020!S8.@@ CEC2020 Bound-Constrained Suite}\label{sec:supp:cec2020}
...
The registration is content-bound and auditable: the addendum's SHA-256 is
recorded in the evidence release manifest that carries every CEC2020 datum,
so the registered text cannot have been revised after those results existed,
and its two dated,
...
AGSK was the runner-up of the CEC2020 competition~@@CITE!mohamed2020agsk@@, and
...
addendum's Section~9 outcome sentences had been committed before any datum existed
...
\subsection{@@SECNUM!sec:supp:cec2020:standing!S8.1.@@ Descriptive Standing}\label{sec:supp:cec2020:standing}

On AGSK's strongest suite --- the CEC2020 competition in which it was
the runner-up~@@CITE!mohamed2020agsk@@ --- \dtgsk{} places fourth; the family
...
\begin{table}[H]
\caption{@@TABLECAP!tab:supp:cec2020:ranks@@ CEC2020 tie-corrected Friedman mean ranks per dimension and the
...
\subsection{@@SECNUM!sec:supp:cec2020:omnibus!S8.2.@@ Omnibus Tests by Dimension}\label{sec:supp:cec2020:omnibus}
...
\begin{table}[H]
\caption{@@TABLECAP!tab:supp:cec2020:omnibus@@ CEC2020 omnibus tests by dimension (error basis, floor
...
\subsection{@@SECNUM!sec:supp:cec2020:pairwise!S8.3.@@ Pairwise Comparisons Against \dtgsk{}}\label{sec:supp:cec2020:pairwise}
...
\begin{table}[p]
\caption{@@TABLECAP!tab:supp:cec2020:pairwise@@ Across-function Wilcoxon layer on CEC2020, \dtgsk{} vs.\ each
...
\begin{table}[p]
\caption{@@TABLECAP!tab:supp:cec2020:pairwise-run@@ Run-level Wilcoxon layer on CEC2020: per-function paired
...
\subsection{@@SECNUM!sec:supp:cec2020:effects!S8.4.@@ Effect Sizes}\label{sec:supp:cec2020:effects}
...
\begin{table}[p]
\caption{@@TABLECAP!tab:supp:cec2020:effects@@ Run-level effect sizes on CEC2020: $A_{12}$/Cliff's $\delta$
...
\clearpage
\subsection{@@SECNUM!sec:supp:cec2020:robustness!S8.5.@@ Robustness}\label{sec:supp:cec2020:robustness}
...
\begin{table}[H]
\caption{@@TABLECAP!tab:supp:cec2020:robustness@@ CEC2020 registered across-dimension aggregate robustness: the
...
\subsection{@@SECNUM!sec:supp:cec2020:detail!S8.6.@@ Per-Function Detail}\label{sec:supp:cec2020:detail}
...
\begin{table}[p]
\caption{@@TABLECAP!tab:supp:cec2020-detail-d5@@ CEC2020 at $D = 5$: best / median / mean / worst / SD of
...
\begin{table}[p]
\caption{@@TABLECAP!tab:supp:cec2020-detail-d10@@ CEC2020 at $D = 10$: best / median / mean / worst / SD of
the final error over 30 runs for all 7 GSK-family algorithms
on all 10 functions;
$\mathrm{MaxFES}$ per the dimension-dependent budget; success floor
$10^{-8}$; best mean per function in bold (ties all bold).
...
\begin{table}[p]
\caption{@@TABLECAP!tab:supp:cec2020-detail-d15@@ CEC2020 at $D = 15$: best / median / mean / worst / SD of
the final error over 30 runs for all 7 GSK-family algorithms
on all 10 functions;
$\mathrm{MaxFES}$ per the dimension-dependent budget; success floor
$10^{-8}$; best mean per function in bold (ties all bold).
...
\begin{table}[p]
\caption{@@TABLECAP!tab:supp:cec2020-detail-d20@@ CEC2020 at $D = 20$: best / median / mean / worst / SD of
the final error over 30 runs for all 7 GSK-family algorithms
on all 10 functions;
$\mathrm{MaxFES}$ per the dimension-dependent budget; success floor
$10^{-8}$; best mean per function in bold (ties all bold).
...
\section{@@SECNUM!sec:supp:revision!S9.@@ Mechanism-Isolation and Sensitivity Experiments}\label{sec:supp:revision}
...
named in the Data Availability Statement, so the registered adverse wording
can be read directly against what is reported here.  The later amendments
carry commit-level dates in that repository; the earlier registrations are
bound instead by the checksums recorded in the evidence release manifests,
because the published history is a squashed import and does not preserve the
...
A5-A6 and restated at the point of use below.  A second, earlier departure
is recorded as Amendment~A3: for Experiments E2 and E3 the executed Holm
families correct across dimensions where the registered plan specified
within dimension.  The amendment records the departure, its direction, and
the verification that every decision reported here is unchanged under the
registered family; for E2 the registered family would have had one member,
so the executed correction is the more conservative of the two.
...
\subsection{@@SECNUM!sec:supp:rev:basis!S9.1.@@ Refinement Basis: Eigenframe, Coordinate Axes, or None}\label{sec:supp:rev:basis}
...
Table~@@REF!tab:rev-e1@@ reports the contrast.
...
@@TABLECAP!tab:rev-e1!SA05@@ Refinement-basis contrast on CEC2017 at the two dimensions where the
...
arm as reference, so $A_{12} < 0.5$ favours the second; between-function scale
dominates the pooled pairs and compresses the statistic toward $0.5$, so a
value near $0.5$ here does not indicate a null contrast.  W/T/L counts functions with wins
credited to the first-named arm, ties at a tolerance of $10^{-8}$; the same
band is applied before ranking, and
...
\subsection{@@SECNUM!sec:supp:rev:np!S9.2.@@ Matched Population Size}\label{sec:supp:rev:np}
...
that the main text discloses but the panel evidence does not control.
Table~@@REF!tab:rev-e2@@ reports the outcome.  This experiment
...
@@TABLECAP!tab:rev-e2!SA06@@ \dtgsk{} at the comparators' population value.  Mean ranks and ordinal
...
\subsection{@@SECNUM!sec:supp:rev:tiering!S9.3.@@ Tiered Versus Tier-Constant Configuration}\label{sec:supp:rev:tiering}

The manuscript attributes its standing to resolving configuration by dimension,
but the panel evidence does not compare the tiered configuration against an
...
@@TABLECAP!tab:rev-e3!SA07@@ Tiered configuration versus the two tier-constant transplants on
...
the archived values on none, and reproduces both wherever the two legs agree
(26 divergent and 229 agreeing of the 255 (function, run) cells re-executed,
with zero seed mismatches).
...
low-dimension transplant it is not separated at $D = 50$ or $D = 100$ --- at
$D = 10$ it carries the tiered configuration by construction, so that tie is
the design's internal control, not evidence --- and at $D = 30$ it is beaten: the parameter set that \dtgsk{} resolves at $D = 10$
...
weakness the main text already discloses descriptively --- $D = 30$
...
\subsection{@@SECNUM!sec:supp:rev:sensitivity!S9.4.@@ Selected-Constant Sensitivity (Exploratory)}\label{sec:supp:rev:sensitivity}
...
the interaction-memory update cadence,
...
spans the full scored set.  Table~@@REF!tab:rev-e4@@ reports every executed cell.
...
formula.  The executed levels bound what was tested: the robustness reading for those
cells attaches to the larger perturbations actually run --- no monotonicity in
perturbation size is assumed --- so the registered magnitude on the tested
side, like the whole of the untested side, carries no claim.



@@TABLECAP!tab:rev-e4!SA08@@ Exploratory one-factor sensitivity of \dtgsk{}'s panel standing.
...
panel's 51.  Real-valued constants are perturbed by $\pm 20\%$ and integer-valued
constants to the nearest different integer, as registered; the table prints the
levels actually executed.  $^{\ast}$Executed levels at $D = 100$ exceed the registered
...
\subsection{@@SECNUM!sec:supp:rev:boundary!S9.5.@@ Dimension-Boundary Sensitivity}\label{sec:supp:rev:boundary}
...
nothing earlier is re-minted.  Table~@@REF!tab:rev-e5@@ reports the five
registered contrasts.




@@TABLECAP!tab:rev-e5!SA09@@ Dimension-boundary sensitivity on CEC2017 (E5).  One Holm family
across the five registered boundary contrasts; four cells use 15 paired runs
against the frozen tiered leg restricted to the same runs, and the $20 \to 31$
cell at $D = 30$ reuses the 51 runs of the corresponding transplant; paired
Wilcoxon on
...
means ($p_{\mathrm{Holm}} = 1.5\times10^{-2}$, 22 of 29) and moves the
descriptive mean rank from $2.34$ to $1.97$, while the family
...
@@BIBENT!liang2013cec2013!3@@ Liang, J.J.; Qu, B.Y.; Suganthan, P.N.; Hern{\'a}ndez-D{\'i}az, A.G. Problem Definitions and Evaluation Criteria for the {CEC} 2013 Special Session on Real-Parameter Optimization. Technical report, Zhengzhou University and Nanyang Technological University, 2013.

@@BIBENT!yue2020cec2020!4@@ Yue, C.T.; Price, K.V.; Suganthan, P.N.; Liang, J.J.; Ali, M.Z.; Qu, B.Y.; Awad, N.H.; Biswas, P.P. Problem Definitions and Evaluation Criteria for the {CEC} 2020 Special Session and Competition on Single Objective Bound Constrained Numerical Optimization. Technical Report 201911, Computational Intelligence Laboratory, Zhengzhou University, Zhengzhou China and Nanyang Technological University, Singapore, 2019.

@@BIBENT!li2013lsgo!5@@ Li, X.; Tang, K.; Omidvar, M.N.; Yang, Z.; Qin, K. Benchmark Functions for the {CEC}'2013 Special Session and Competition on Large-Scale Global Optimization. Technical report, RMIT University, Melbourne, Australia, 2013.

@@BIBENT!wilcoxon1945individual!6@@ Wilcoxon, F. Individual Comparisons by Ranking Methods. \emph{Biometrics Bulletin} \textbf{1945}, \emph{1},~80--83. doi:{\href{https://doi.org/10.2307/3001968}{10.2307/3001968}}.

@@BIBENT!holm1979simple!7@@ Holm, S. A Simple Sequentially Rejective Multiple Test Procedure. \emph{Scandinavian Journal of Statistics} \textbf{1979}, \emph{6},~65--70. The 1979 issue predates CrossRef DOI assignment for this journal; the canonical stable identifier is the JSTOR record at https://www.jstor.org/stable/4615733.

@@BIBENT!friedman1937use!8@@ Friedman, M. The Use of Ranks to Avoid the Assumption of Normality Implicit in the Analysis of Variance. \emph{Journal of the American Statistical Association} \textbf{1937}, \emph{32},~675--701. doi:{\href{https://doi.org/10.1080/01621459.1937.10503522}{10.1080/01621459.1937.10503522}}.

@@BIBENT!demsar2006statistical!9@@ Dem\v{s}ar, J. Statistical Comparisons of Classifiers over Multiple Data Sets. \emph{Journal of Machine Learning Research} \textbf{2006}, \emph{7},~1--30. JMLR volumes from 2006 predate formal DOI assignment; the canonical publisher-hosted record is at https://www.jmlr.org/papers/v7/demsar06a.html.

@@BIBENT!efron1993introduction!10@@ Efron, B.; Tibshirani, R.J. \emph{An Introduction to the Bootstrap}; Chapman \& Hall: New York, 1993. doi:{\href{https://doi.org/10.1201/9780429246593}{10.1201/9780429246593}}.

@@BIBENT!mohamed2020gaining!11@@ Mohamed, A.W.; Hadi, A.A.; Mohamed, A.K. Gaining-Sharing Knowledge Based Algorithm for Solving Optimization Problems: A Novel Nature-Inspired Algorithm. \emph{International Journal of Machine Learning and Cybernetics} \textbf{2020}, \emph{11},~1501--1529. doi:{\href{https://doi.org/10.1007/s13042-019-01053-x}{10.1007/s13042-019-01053-x}}.

@@BIBENT!mohamed2020agsk!12@@ Mohamed, A.W.; Hadi, A.A.; Mohamed, A.K.; Awad, N.H. Evaluating the Performance of Adaptive Gaining-Sharing Knowledge Based Algorithm on {CEC} 2020 Benchmark Problems. Proceedings of the 2020 IEEE Congress on Evolutionary Computation (CEC). IEEE, 2020, pp. 1--8. doi:{\href{https://doi.org/10.1109/CEC48606.2020.9185901}{10.1109/CEC48606.2020.9185901}}.

@@BIBENT!apgsk2021!13@@ Mohamed, A.W.; Abutarboush, H.F.; Hadi, A.A.; Mohamed, A.K. Gaining-Sharing Knowledge Based Algorithm With Adaptive Parameters for Engineering Optimization. \emph{IEEE Access} \textbf{2021}, \emph{9},~65934--65946. doi:{\href{https://doi.org/10.1109/ACCESS.2021.3076091}{10.1109/ACCESS.2021.3076091}}.

@@BIBENT!fdbagsk2023!14@@ Bak{\i}r, H.; Duman, S.; Guvenc, U.; Kahraman, H.T. Improved Adaptive Gaining-Sharing Knowledge Algorithm with {FDB}-Based Guiding Mechanism for Optimization of Optimal Reactive Power Flow Problem. \emph{Electrical Engineering} \textbf{2023}, \emph{105},~3121--3160. doi:{\href{https://doi.org/10.1007/s00202-023-01803-9}{10.1007/s00202-023-01803-9}}.

@@BIBENT!alfadli2025atmals!15@@ Alfadli, N.M.; Oun, E.M.; Mohamed, A.W. Auto-Tuning Memory-Based Adaptive Local Search Gaining--Sharing Knowledge-Based Algorithm for Solving Optimization Problems. \emph{Algorithms} \textbf{2025}, \emph{18},~398. doi:{\href{https://doi.org/10.3390/a18070398}{10.3390/a18070398}}.

@@BIBENT!jawad2024egsk!16@@ Jawad, M.A.; Roshdy, H.S.M.; Mohamed, A.W. Enhanced Gaining-Sharing Knowledge-Based Algorithm. \emph{Results in Control and Optimization} \textbf{2025}, \emph{19},~100542. doi:{\href{https://doi.org/10.1016/j.rico.2025.100542}{10.1016/j.rico.2025.100542}}.

@@BIBENT!molina2018shadeils!17@@ Molina, D.; LaTorre, A.; Herrera, F. {SHADE} with Iterative Local Search for Large-Scale Global Optimization. 2018 IEEE Congress on Evolutionary Computation (CEC). IEEE, 2018, pp. 1--8. doi:{\href{https://doi.org/10.1109/CEC.2018.8477755}{10.1109/CEC.2018.8477755}}.

@@BIBENT!latorre2013mos!18@@ LaTorre, A.; Muelas, S.; Pe{\~n}a, J.M. Large Scale Global Optimization: Experimental Results with {MOS}-based Hybrid Algorithms. Proceedings of the 2013 IEEE Congress on Evolutionary Computation. IEEE, 2013, pp. 2742--2749. doi:{\href{https://doi.org/10.1109/CEC.2013.6557901}{10.1109/CEC.2013.6557901}}.
\end{document}
