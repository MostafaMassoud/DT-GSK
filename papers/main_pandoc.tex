...
donor or selection policy. \agsk{} draws its $(K_F, K_R)$ settings from a
...
Where a value varies by
dimension tier, the four tiers $D{<}20$ / $20$--$49$ / $50$--$99$ / ${\ge}100$
are shown. No tuning is required or permitted at run time. Hash-frozen in
...
$N_{\min}$ & 25 at $D\ge50$ (12 bare) & tier floor\\
...
controllers) are listed in the Supplementary Materials, Section~S5.}
\end{table}
...
$D = 100$ --- which is a design choice inherited from each algorithm's own
published defaults rather than a controlled variable. Third, CEC2017 is
