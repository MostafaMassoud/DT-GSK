...
@@ALGLINE!1!0@@ Initialize the interaction graphs $G_{\mathrm{abs}}, G_{\mathrm{signed}} \gets 0$ (allocated only at $D\ge50$)
...
@@ALGLINE!13!1@@ \textbf{if} DE arm: overwrite the trial's binomially masked coordinates with a DE/rand/1 mutant \ \ $\triangleright$~$F{=}0.5$, $CR{=}0.9$

@@ALGLINE!14!1@@ Repair the out-of-bound coordinates

@@ALGLINE!15!1@@ Evaluate the maximal prefix of $\{v_i\}$ that fits the remaining budget \ \ $\triangleright$~unevaluated rows are non-selectable
...
@@ALGLINE!20!1@@ \textbf{if} in the endgame slice, under the evaluation cap and past cooldown: charged coordinate local search on the elite rows \ \ $\triangleright$~$\ge0.80$ below $D{=}50$; $\ge0.70$ above
...
@@ALGLINE!21!1@@ \textbf{if} $D{\ge}50$: polish the working incumbent $x^{*}$ once, in the final budget slice \ \ $\triangleright$~Eq.~(@@REF!eq:eigen-polish@@)
...
tag v2.32, and any further materials are
