...
reference-implementation setting. The asymmetry was not a controlled variable
at submission; it was controlled in revision (Supplementary Materials,
Section~S9.2), and \dtgsk{} stays within the top two of the panel at every
...
Section~S9.4). It is descriptive and carries no hypothesis test. The
boundary study registered ahead of resubmission (Supplementary Materials,
...
tag v2.22, and any further materials are
...
checksummed manifest; the four round-one revision experiments are carried by a
fourth additive, non-superseding release, rev-rel-2026-08-26-dd42d37eb, which
leaves every primary value unchanged; the boundary-sensitivity experiment
added ahead of resubmission is carried by a fifth additive release,
rev2-rel-2026-08-28-203c78744, on the same terms; and the derived statistical artifacts
