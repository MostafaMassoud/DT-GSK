...
Regenerated 2026-08-29 from the pass-56 / v2.29 REVISION-1 sources (the
...
this revised version to tag v2.29 — matching the manuscript's own Data
...
2. Do NOT rebuild anything in the repo afterwards. The five shipped artifacts
   ...
   `submission_package_manifest.json` at **v2.29** — that record is what makes
   ...
   are uploaded but hash-recorded nowhere. Freeze pass-56 and tag
   v2.29 are the frozen state of this resubmission, exactly as pass-38 / v2.13
...
4. Two of the uploaded artifacts — the response letter and the change register —
   ...
   `git diff v2.13 v2.29` over the manuscript sources.
