...
%==================================================================
% S9 -- Round-one revision experiments (E1-E4). Every value in this
% section is machine-transcribed by papers/scripts/generate_revision_exhibits.py
% from the release-bound bundle papers/analysis/rev-rel-2026-08-26-dd42d37eb/,
% which is generated strict-source from the promoted evidence release
% rev-rel-2026-08-26-dd42d37eb with seed-verified pairing and fail-closed
% known-answer pins.  Designs and reporting constraints were fixed in
% papers/review_2026_08_24/revision_experiments_preregistration.md, signed
% 2026-08-25 before any result from these experiments existed.
%==================================================================
\section{Round-One Revision Experiments}\label{sec:supp:revision}
...
\subsection{Parameter Sensitivity (Exploratory)}\label{sec:supp:rev:sensitivity}
