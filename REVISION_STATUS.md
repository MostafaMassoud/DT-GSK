...
| **Freeze** | **pass-55 / tag v2.28** (anchor `1586242`) · `check_manifest` 15/15 + `sources 2/2` · **PUSHED 2026-08-29** — all 28 tags on `origin`, v2.13 and v2.28 verified resolving there at the same commits as local. Repo is **PRIVATE until upload day** — flip public before SuSy upload. Next free ids **CR-0036 / D-0061**. |
...
the current freeze is **pass-55 / v2.28** at 15/15 + sources 2/2, and `origin/main` carries it —
