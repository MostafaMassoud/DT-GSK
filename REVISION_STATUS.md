...
| **Freeze** | **pass-59 / tag v2.32** (anchor `ed713a7`) · `check_manifest` 15/15 + `sources 2/2` (gating commit-field resolvability) · minted and tagged 2026-08-29; push, then verify all 32 tags on `origin` (the DAS names v2.13 and v2.32). Repo is **PRIVATE until upload day** — flip public before SuSy upload. Next free ids **CR-0040 / D-0065**. |
