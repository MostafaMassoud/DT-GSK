...
| **Freeze** | **pass-63 / tag v2.36** (anchor `fcb17f2`) · `check_manifest` 15/15 + `sources 2/2` (gating commit-field resolvability) · minted and tagged 2026-08-30; push, then verify all 36 tags on `origin` (the DAS names v2.13 and v2.36). Repo is **PRIVATE until upload day** — flip public before SuSy upload. Next free ids **CR-0044 / D-0069**. |
