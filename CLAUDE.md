...
**Current freeze: pass-73 / `v2.46`** — minted and tagged 2026-09-03. Next free ids:
**CR-0054 / D-0079** — verify free at apply time.
**Pass-73 (2026-09-03, D-0078 / CR-0053) de-dashes the REPOSITORY's own sources** (main.tex, the five sections, the plain summary): 275 of 279 printing em-dashes replaced, 14 kept. They had been missed because passes 69 and 71 edited the returned proof, the supplement and the letter — **a change described as applying to "the manuscript" reaches only the file actually edited.** The parenthesis-balance check aborted the first run unwritten, catching two parentheticals whose closing point carried no dash.
