...
> the `CLAUDE.md` "Right now" block. As of this refresh: **pass-60 / tag v2.33**
> (decision log through **D-0065**, register through **CR-0040**,
> next free **CR-0041 / D-0066** — verify free at apply time); the round-one revision at *Algorithms* (MDPI) is
...
> SuSy upload — the Data Availability Statement names its URL and tags `v2.13`/`v2.33`;
