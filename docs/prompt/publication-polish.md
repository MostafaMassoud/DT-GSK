...
> the `CLAUDE.md` "Right now" block. As of this refresh: **pass-58 / tag v2.31**
> (decision log through **D-0063**, register through **CR-0038**,
> next free **CR-0039 / D-0064** — verify free at apply time); the round-one revision at *Algorithms* (MDPI) is
...
> SuSy upload — the Data Availability Statement names its URL and tags `v2.13`/`v2.31`;
