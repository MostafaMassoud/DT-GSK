...
> the `CLAUDE.md` "Right now" block. As of this refresh: **pass-57 / tag v2.30**
> (decision log through **D-0062**, register through **CR-0037**,
> next free **CR-0038 / D-0063** — verify free at apply time); the round-one revision at *Algorithms* (MDPI) is
...
> SuSy upload — the Data Availability Statement names its URL and tags `v2.13`/`v2.30`;
