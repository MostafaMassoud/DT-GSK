...
| R2.3 | Isolate the eigenframe: compare none / coordinate / eigenframe at one budget | **Experiment E1.** The polish beats no refinement at both active dimensions — **but the learned eigenbasis is beaten by plain coordinate axes at D = 50** and, under the canonical 1e-8 tie rule, at D = 100 as well (Holm 0.0489; Amendments A5–A6). Contribution C1 is therefore claimed basis-neutrally | 2,958 runs |
...
through, in place) *and* a **change register** listing all 102 changed passages as-submitted against
